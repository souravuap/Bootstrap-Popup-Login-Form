        ...
        switch(this.id) {
            case "login-form":
                ...
                if ($lg_username == "ERROR") {
                    msgChange($('#div-login-msg'), $('#icon-login-msg'), $('#text-login-msg'), "error", "fa-close", "Login error");
                } else {
            ...
            case "lost-form":
                ...
                if ($ls_email == "ERROR") {
                    msgChange($('#div-lost-msg'), $('#icon-lost-msg'), $('#text-lost-msg'), "error", "fa-close", "Send error");
                } else {
            ...
            case "register-form":
                ...
                if ($rg_username == "ERROR") {
                    msgChange($('#div-register-msg'), $('#icon-register-msg'), $('#text-register-msg'), "error", "fa-close", "Register error");
                } else {
